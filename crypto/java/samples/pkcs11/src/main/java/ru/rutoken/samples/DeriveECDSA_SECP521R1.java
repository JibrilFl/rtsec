...
import static ru.rutoken.samples.utils.Util.RECIPIENT_ECDSA_SECP521R1_PUBLIC_KEY;

/**
 * Sample of deriving a key from ECDSA key pair with secp521r1 curve and recipient ECDSA public key.
 * Expects key pair on token, you should run {@link CreateKeyPairAndCertificateECDSA_SECP521R1} sample to create it.
 * </br>
 * WARNING: Deriving a key from ECDSA key pair with secp521r1 curve is currently not working correctly.
 */
public class DeriveECDSA_SECP521R1 {
    /**
    ...
    static {
        ...
        privateKeyTemplate[1].setAttr(CKA_ID, CreateKeyPairAndCertificateECDSA_SECP521R1.KEY_PAIR_ID);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            CK_ECDH1_DERIVE_PARAMS deriveParameters =
                    new CK_ECDH1_DERIVE_PARAMS(new NativeLong(CKD_NULL), RECIPIENT_ECDSA_SECP521R1_PUBLIC_KEY, null);
