...
/**
 * Sample of deriving a key from GOST R 34.10-2012 (256 bits) key pair and recipient public key.
 * Expects key pair on token, you should run {@link CreateKeyPairAndCertificateGOSTR3410_2012_256} sample to create it.
 */
public class DeriveGOSTR3410_2012_256 {
    ...
    static {
        ...
        privateKeyTemplate[1].setAttr(CKA_ID, CreateKeyPairAndCertificateGOSTR3410_2012_256.KEY_PAIR_ID);
        privateKeyTemplate[2].setAttr(CKA_KEY_TYPE, CKK_GOSTR3410_256);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Memory deriveParameters = allocateDeriveParamsGOSTR3410_2012((int) CKD_CPDIVERSIFY_KDF,
                    RECIPIENT_GOST_PUBLIC_KEY_256, deriveParamUkm);

            CK_MECHANISM deriveMechanism = new CK_MECHANISM(CKM_GOSTR3410_12_DERIVE, deriveParameters,
