...
/**
 * Sample of rtpkcs11ecp PKI extensions usage via JNA with GOST R 34.10-2001 key pair.
...
public class PkiExtensionsGOSTR3410_2001 {
    ...
    static {
        ...
        certificateTemplate[2].setAttr(CKA_ID, CreateKeyPairAndCertificateGOSTR3410_2001.KEY_PAIR_ID);
